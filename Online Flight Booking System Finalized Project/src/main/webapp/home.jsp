...
<title>Phoenix Airlines Flight Reservation System</title>
<style>
h3
{
	color: yellow;
...
<body>
<div style="color: yellow; text-align: center; font-size: 30px; "> <b>Your Trusted Traveling Partner</b> <i class="fa fa-plane"></i></div>
<%
