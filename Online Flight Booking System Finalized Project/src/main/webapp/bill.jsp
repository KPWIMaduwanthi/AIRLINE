...
try{
	...
	{
%>
<h3>Online Reservation Bill (Phoenix Airlines Pvt.)</h3>
<hr>
...
<h3> Flight Details</h3>
  ...
  <%
  ResultSet rs1=st.executeQuery("select *from cart inner join flight where cart.flight_id=flight.id and cart.email='"+email+"' and cart.status='bill'");
  while(rs1.next())
  {
	  sno=sno+1;
...
<a href="continue.jsp"><button class="button left-button">Continue Browsing</button></a>
