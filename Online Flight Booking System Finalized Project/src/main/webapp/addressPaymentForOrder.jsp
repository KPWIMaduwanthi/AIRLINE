...
<div class="right-div">
<h3>Pay online on this pheonixAir@pay.com</h3>
...
<button class="button" type="submit"> Proced To Generate Bill And Save<i class='far fa-arrow-alt-circle-right'></i></button>
