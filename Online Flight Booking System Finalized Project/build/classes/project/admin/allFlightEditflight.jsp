...
<body>
<div style="color: white; text-align: center; font-size: 30px;"><b>All Flights And Edit Flights</b> <i class='fab fa-elementor'></i></div>
<%
       ...
       try{
    	...
    	%> 
          ...
          <tr>
            ...
            <td><i class="fa fa-doller"></i><%=rs.getString(6) %></td>
