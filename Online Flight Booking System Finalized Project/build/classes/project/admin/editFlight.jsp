...
<input class="input-style" type="date" name="date" value="<%=rs.getString(4) %>" required> 
<hr>
</div>

<div class="right-div">
<h3>Scheduled Time</h3>
 <input class="input-style" type="time" name="time" value="<%=rs.getString(5) %>" required> 
<hr>
</div>

<div class="left-div">
<h3>Price</h3>
 <input class="input-style" type="number" name="price" value="<%=rs.getString(6) %>" required> 
<hr>
</div>
