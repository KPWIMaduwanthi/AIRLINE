...
<div class="left-div">
 <h3> Business Class Price </h3> 
  <input class="input-style" type="number" name="pricecl1" placeholder="Enter Business Class Price" required>
<hr>
</div>

<div class="right-div">
<h3> Economy Class Price</h3>
 <input class="input-style" type="number" name="pricecl2" placeholder="Enter Economy Class Price" required>   
<hr>
</div>
